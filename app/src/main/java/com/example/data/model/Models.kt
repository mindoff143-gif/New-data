...
data class AssistantChatMessage(
    ...
    val attachmentType: String? = null, // "IMAGE", "DOCUMENT", "FILE"
...
data class SaharanpurNewsEntity(
    ...
    val includeCopyright: Boolean = true,
    val copyrightAttribution: String? = null
)
...
data class FacebookPublishResult(
    ...
    val openedDirectApp: Boolean = false
)
