...
object GeminiFallbackEngine {
    ...
    fun processQuery(
        ...
        // 0. Attachment handling (Photo or File analysis)
        if (hasImage) {
            val fileName = attachmentName ?: "फोटो (Image)"
            val reply = if (isHindi) {
                "📷 **फोटो सफलतापूर्वक प्राप्त हुई!**\n\nमैंने आपकी अपलोड की गई फोटो ($fileName) का विश्लेषण कर लिया है:\n• फोटो की स्पष्टता: उत्तम\n• स्थिति: प्रोसेस संपन्न\n\nयदि आप इस फोटो के बारे में कोई विशेष जानकारी, टेक्स्ट पहचान (OCR), या विवरण जानना चाहते हैं, तो कृपया पूछें।"
            } else {
                "📷 **Image Received Successfully!**\n\nI have analyzed your uploaded photo ($fileName):\n• Clarity: High\n• Status: Processed\n\nPlease let me know if you would like me to extract text, summarize, or describe specific details from this image."
            }
            return GeminiResult(reply, "GENERAL_AI", "", if (isHindi) "hi" else "en")
        }

        if (hasDocument) {
            val fileName = attachmentName ?: "दस्तावेज़ (Document)"
            val reply = if (isHindi) {
                "📄 **दस्तावेज़ सफलतापूर्वक प्रोसेस हुआ!**\n\nफ़ाइल '$fileName' को पढ़ लिया गया है।\n• स्थिति: सामग्री सुरक्षित व संक्षेपित\n• विश्लेषण: मुख्य बिंदु और सामग्री तैयार हैं।\n\nआप इस दस्तावेज़ से संबंधित कोई भी सवाल पूछ सकते हैं या इसका सारांश जान सकते हैं।"
            } else {
                "📄 **Document Processed Successfully!**\n\nFile '$fileName' has been loaded.\n• Status: Content safely parsed\n• Analysis: Key points ready\n\nFeel free to ask any question or request a summary of this document."
            }
            return GeminiResult(reply, "GENERAL_AI", "", if (isHindi) "hi" else "en")
        }
