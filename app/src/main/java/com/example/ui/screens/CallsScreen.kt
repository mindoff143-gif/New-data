...
fun CallsScreen(
    ...
    onTriggerReceiveCall: (name: String, number: String) -> Unit = { _, _ -> },
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Row(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Column {
                            Text(
                                text = "स्मार्ट AI कॉल स्क्रीनर व रिसीवर",
                ...
                Text(
                    text = if (preferredLanguage == "hi")
                        "अज्ञात या स्पैम कॉल्स आने पर AI स्वतः कॉल पिक करके कॉलर से उनका उद्देश्य पूछता है। आप स्वयं भी कॉल उठा सकते हैं।"
                    else
                        "When calls ring, you can receive them directly or let AI answer automatically and screen spam callers.",
                    style = MaterialTheme.typography.bodySmall.copy(
                ...
                // Call Action Buttons (Receive Call directly or Test AI screening)
                Row(
                    modifier = Modifier.fillMaxWidth(),
                    horizontalArrangement = Arrangement.spacedBy(8.dp)
                ) {
                    // Receive Call directly
                    Button(
                        onClick = {
                            onTriggerReceiveCall("Rahul Sharma (Office)", "+91 98123 45678")
                        },
                        modifier = Modifier
                            .weight(1f)
                            .height(46.dp)
                            .testTag("receive_call_test_button"),
                        ...
                        Text(
                            text = if (preferredLanguage == "hi") "कॉल उठाएं टेस्ट" else "Receive Call",
                            fontWeight = FontWeight.Bold,
                            color = Color.White,
                            fontSize = 12.sp
                        )
                    ...
                    Button(
                        ...
                        Spacer(modifier = Modifier.width(6.dp))
                        Text(
                            text = if (preferredLanguage == "hi") "AI स्क्रीनिंग" else "Screening",
                            fontWeight = FontWeight.Bold,
                            color = Color.White,
                            fontSize = 12.sp
                        )
        ...
        Column(modifier = Modifier.padding(14.dp)) {
            ...
            Row(
                ...
                Row(
                    ...
                    // Call Back / Dial Button
                    OutlinedButton(
                        onClick = {
                            try {
                                val intent = Intent(Intent.ACTION_DIAL).apply {
                                    data = Uri.parse("tel:${log.contactNumber}")
                                }
