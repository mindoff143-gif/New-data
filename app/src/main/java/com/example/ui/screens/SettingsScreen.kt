...
fun SettingsScreen(
    ...
    Column(
        ...
        // Voice Speaking Permission Card (User Controlled)
        Card(
            shape = RoundedCornerShape(20.dp),
            colors = CardDefaults.cardColors(containerColor = MaterialTheme.colorScheme.surface),
            elevation = CardDefaults.cardElevation(defaultElevation = 2.dp),
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Row(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.weight(1f)) {
                        Box(
                            modifier = Modifier
                                .size(36.dp)
                                .background(
                                    if (voiceOutputAllowed) Color(0xFF10B981).copy(alpha = 0.15f) else MaterialTheme.colorScheme.onSurface.copy(alpha = 0.08f),
                                    CircleShape
                                ),
                        ...
                        Column {
                            Text(
                                text = "AI वॉइस उत्तर (Voice Output)",
                                style = MaterialTheme.typography.titleMedium.copy(
                                    fontWeight = FontWeight.Bold
                                )
                            )
                            Text(
                                text = if (voiceOutputAllowed) "चालू: AI बोलकर जवाब देगा" else "बंद: केवल लिखकर बताएगा (Silent)",
                                style = MaterialTheme.typography.bodySmall.copy(
                                    color = if (voiceOutputAllowed) Color(0xFF059669) else MaterialTheme.colorScheme.onSurfaceVariant,
                    ...
                    Switch(
                        ...
                        modifier = Modifier.testTag("settings_voice_output_switch")
                    )
                }
                Spacer(modifier = Modifier.height(6.dp))
                Text(
                    text = "जब यह बंद होगा तो AI कोई आवाज़ नहीं निकालेगा, सिर्फ स्क्रीन पर टेक्स्ट लिखकर बताएगा।",
                    style = MaterialTheme.typography.bodySmall.copy(
                        color = MaterialTheme.colorScheme.onSurfaceVariant,
                        lineHeight = 16.sp
                    )
