        ...
        Card(
            ...
            Column(
                ...
                Row(
                    ...
                    FilterChip(
                        selected = selectedPlatform == "CALL",
                        onClick = { selectedPlatform = "CALL" },
                ...
                Button(
                    ...
                    Icon(
                        imageVector = if (selectedPlatform == "CALL") Icons.Default.Call else Icons.AutoMirrored.Filled.Send,
                    ...
                    Text(
                        text = if (selectedPlatform == "CALL") "सीधे कॉल लगाएं (Direct Call)" else "$selectedPlatform भेजें (Dispatch)",
                        fontWeight = FontWeight.Bold,
                        color = Color.White
                    )
                }
